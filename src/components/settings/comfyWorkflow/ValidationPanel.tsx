      ...
      {validation.fatalErrors.length > 0 && (
        <div style={{ marginBottom: '4px' }}>
          {validation.fatalErrors.map((e, i) => (
            <div key={i} style={{ color: 'var(--stamp-red)', marginBottom: '2px' }}>
